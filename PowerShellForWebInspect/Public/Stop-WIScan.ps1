function Stop-WIScan {
    <#
    .SYNOPSIS
        Stops a WebInspect scan.
    .DESCRIPTION
        Stops an existing WebInspect Scan
    .PARAMETER ScanId
    ...
    .PARAMETER ForceVerbose
        ...
        Default value is the value set by Set-WIConfig
    .EXAMPLE
        # Stops the scan with id "1cec4067-cb67-42ed-8f00-e5220b5afc04"
    ...
    begin
    {
        ...
        Write-Verbose "Stop-WIScan Bound Parameters:  $( $PSBoundParameters | Remove-SensitiveData | Out-String )"
    }
    process
    {

        Write-Verbose "Stop-WIScan: -Method Post -Operation '/scanners/scans/${ScanId}?action=stop"
        $Response = Send-WIApi -Method Post -Operation "/scanner/scans/${ScanId}?action=stop" @Params
    }
    end {
        $Response
    }
